...
Định hướng giải pháp tổng thể là xây dựng kiến trúc \textit{RL-OA-MP-VNE} gồm một bộ mã hoá đồ thị (GCN encoder), ba đầu ra tác vụ (đầu xếp hạng nút ảo, đầu xếp hạng liên kết ảo và đầu chọn ứng viên cross-attention), kết hợp với quy trình huấn luyện hai giai đoạn: tiền huấn luyện có giám sát rồi tinh chỉnh bằng REINFORCE có baseline. Kết quả là một tác nhân vừa kế thừa các quy luật hợp lý của heuristic, vừa có khả năng tự khám phá những phương án ánh xạ tốt hơn mà heuristic không nhìn thấy.

\section{Đóng góp của đồ án}

Đồ án có ba đóng góp chính sau:
\begin{enumerate}
\item Đề xuất kiến trúc \textit{RL-OA-MP-VNE} kết hợp GCN encoder chung với ba đầu ra phối hợp: đầu xếp hạng nút ảo, đầu xếp hạng liên kết ảo, và đầu chọn ứng viên cross-attention với feasibility mask cứng cho ràng buộc CPU.
\item Đề xuất quy trình huấn luyện hai giai đoạn gồm tiền huấn luyện có giám sát từ lời giải OA-MP-VNE và tinh chỉnh bằng REINFORCE với running-mean baseline, đồng thời sử dụng Plackett-Luce sampling cho phép vi phân hoá qua thao tác chọn hoán vị.
\item Xây dựng bộ benchmark đa kịch bản (\texttt{scenario\_1} với tô-pô Waxman ngẫu nhiên, \texttt{conus75} với tô-pô thực CONUS-75, và \texttt{conus75\_strict} với ràng buộc tài nguyên chặt) và tiến hành đánh giá so sánh có hệ thống với các baseline heuristic (MC-VNM, MP-VNE) và RL hiện hành.
\end{enumerate}
