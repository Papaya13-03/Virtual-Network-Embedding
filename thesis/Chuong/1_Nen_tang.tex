...
Chương này hệ thống hoá các kiến thức nền tảng phục vụ cho phương pháp đề xuất. Phần đầu trình bày các công cụ học tăng cường sâu, mạng nơ-ron đồ thị và cơ chế attention — ba khối nền tảng được sử dụng trong đồ án. Phần cuối khảo sát các hướng tiếp cận hiện có cho bài toán nhúng mạng ảo cùng phân tích ưu nhược, làm cơ sở so sánh và xác định động lực cho phương pháp đề xuất. Phát biểu hình thức của bài toán được trình bày riêng ở Chương~\ref{ch:bai_toan}.
...
Phần này khảo sát các hướng tiếp cận hiện có cho bài toán nhúng mạng ảo (được hình thức hoá đầy đủ ở Chương~\ref{ch:bai_toan}). Bên cạnh ba nhóm thuật toán xấp xỉ trình bày dưới đây, bài toán còn có thể phát biểu chính xác dưới dạng quy hoạch nguyên tuyến tính (ILP) cho lời giải tối ưu trong từng bước; tuy nhiên độ phức tạp cấp số mũ khiến cách tiếp cận này chỉ khả thi trên các tô-pô rất nhỏ (dưới $30$ nút), không phù hợp với kịch bản trực tuyến — chi tiết được phân tích cùng phát biểu ILP ở Chương~\ref{ch:bai_toan}.
...
% Kết chương
Chương này đã hệ thống hoá các nền tảng học tăng cường (MDP, gradient chính sách, actor-critic, PPO, Plackett-Luce), các khối GNN và attention, cùng phần khảo sát ba hướng tiếp cận hiện hành cho VNE. Chương tiếp theo phát biểu hình thức bài toán nhúng mạng ảo làm cơ sở cho phương pháp đề xuất.
