...
\usepackage{booktabs} % Bảng đẹp hơn (\toprule, \midrule, \bottomrule)
\usepackage{tikz} % Vẽ sơ đồ kiến trúc
\usetikzlibrary{arrows.meta,positioning,fit,backgrounds,calc}

\usepackage[nonumberlist, nopostdot, nogroupskip, acronym]{glossaries}
\usepackage{glossary-superragged}
\setglossarystyle{superraggedheaderborder}
% Mở rộng cột mô tả để bảng thuật ngữ chiếm gần trọn bề ngang trang
\setlength{\glsdescwidth}{0.82\textwidth}
\usepackage{setspace}
\usepackage{parskip}
...
% Bib name sẽ được đặt lại bằng tiếng Việt ở phần thân tài liệu (\renewcommand\bibname{TÀI LIỆU THAM KHẢO}).
...
\subfile{Chuong/0_5_Mo_dau}

\newpage
\chapter{CƠ SỞ LÝ THUYẾT}
\subfile{Chuong/1_Nen_tang}

\newpage
\chapter{BÀI TOÁN NHÚNG MẠNG ẢO ĐA MIỀN}
\subfile{Chuong/2_Bai_toan}

\newpage
% Chương 4 và 5: mục lục chỉ hiển thị tới mức section (4.1, 5.1), bỏ subsection.
% tocdepth được đặt bên trong từng subfile vì subfiles nạp lại preamble (reset về 2).
\chapter{THUẬT TOÁN ĐỀ XUẤT}
\subfile{Chuong/3_Phuong_phap}

\newpage
\chapter{ĐÁNH GIÁ THỰC NGHIỆM}
\subfile{Chuong/4_Thuc_nghiem}
...
% Mục hướng dẫn về TLTK của template đã được lược bỏ; danh mục TLTK thật được sinh tự động bằng \printbibliography bên dưới.
...
\chapter{CHI TIẾT KIẾN TRÚC, SIÊU THAM SỐ VÀ KẾT QUẢ}
\subfile{Chuong/Phu_luc_A}

\newpage
\chapter{CHI TIẾT TẬP DỮ LIỆU VÀ THUẬT TOÁN SO SÁNH}
