...
class PolicyNetwork(nn.Module):
    ...
    def __init__(
        ...
        # Critic head (state value V(s)) for Actor-Critic baseline.
        # State = mean substrate context + mean vnode features.
        value_input_size = gcn_hidden + vnode_feat_size
    ...
    def forward(
        ...
        Returns:
            ...
            value: scalar V(s) — state value prediction for Actor-Critic baseline
        """
