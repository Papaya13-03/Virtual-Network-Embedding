...
from algorithms.mp_vne_v2.global_controller import GlobalController
...
class MPVNEV2:
    ...
    def solve(self, substrate_network: SubstrateNetwork, virtual_request: VirtualNetworkRequest) -> EmbeddingSolution:
        # V2: cache GlobalController across solves (V6-style). Was rebuilt every
        # call in original mp_vne → 15× slowdown.
