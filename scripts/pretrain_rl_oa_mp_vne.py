#!/usr/bin/env python3
"""Standalone pretrain driver for rl_oa_mp_vne.
...
def main():
    p = argparse.ArgumentParser(description="Pretrain rl_oa_mp_vne with randomized substrate load.")
    ...
    p.add_argument("--checkpoint", default="checkpoints/rl_oa_mp_vne_pretrain.pt")
    p.add_argument("--log-file", default="logs/rl_oa_mp_vne_pretrain.csv")
    ...
    print(f"Pretrain rl_oa_mp_vne: {args.episodes} episodes, batch_size={batch_size}")
